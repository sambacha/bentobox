...
contract CompoundStrategyHarness is StrategyHarness, CompoundStrategy {
    constructor(
        ...
        IERC20 compToken_,
        IERC20 weth_
    ) public CompoundStrategy(bentobox_, factory_, token_, cToken_, compToken_, weth_) {}

    function receiver() public returns (address) {
        return bentobox;
    }

    function tokenBalanceOf(address token, address account) public returns (uint256) {
